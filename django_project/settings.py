...
INSTALLED_APPS = [
    'MoussawiApp.apps.MoussawiappConfig',
...
DATABASES = {
    'default': dj_database_url.config(
        default='postgres://postgres:123@localhost:5432/dragunov', 
        conn_max_age=600
    )
}
...
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'users', 'user_style'),
]
...
LOGIN_REDIRECT_URL = 'MoussawiApp-home'
LOGIN_URL = 'login'
...
LOGOUT_REDIRECT_URL = 'MoussawiApp-home'
